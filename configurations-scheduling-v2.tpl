			...
			<aside class="secondary">
				<nav class="secondary-nav" role="navigation">
					<ul class="nav nav-pills nav-stacked nav-steps">
						...
						<li class="active"><a href="?page=configurations-scheduling" title="Step 5: Scheduling"><span class="badge">6</span> Scheduling</a></li>
					</ul>
				</nav>
			</aside>
			<!-- // End Secondary Nav -->
				...
				<div class="col-md-12">
					...
					<section class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Processing Schedule: SFTP (127.0.0.1)</a></h3>
						</div>
					...
					<section class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Processing Schedule: File Upload (filename.txt)</a></h3>
						</div>
